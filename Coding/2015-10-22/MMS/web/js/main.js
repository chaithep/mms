...
$('a.myprofile').on('click', function(e) {
    ...
    //$('h3#lineModalLabel-profile-form.modal-title-profile').html('<i class="fa fa-user"></i> Set Profile');
...
$('a.setpwd').on('click', function(e) {
   ...
   // $(".modal-body-profile").html('<iframe class="iProfile" id="iProfile"  width="100%" height="100%" frameborder="0" scrolling="no" allowtransparency="true" src="'+url+'"></iframe>');
    ...
    //$('h3#lineModalLabel-profile-form.modal-title-profile').html('<i class="fa fa-user"></i> Set Password');
...
function shDevice_type(unit){
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                var html="<option value='0'>-- Select Device Type --</option>";
