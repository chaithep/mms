...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(com.aerothai.database.building.BuildingResource.class);
        resources.add(com.aerothai.database.building.BuildingsResource.class);
        ...
        resources.add(com.aerothai.database.os.OsResource.class);
        resources.add(com.aerothai.database.os.OssResource.class);
