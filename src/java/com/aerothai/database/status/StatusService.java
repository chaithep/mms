...
public class StatusService {
     ...
     * @throws Exception
     */
    public String createStatus(String query) throws Exception {
     ...
     * @throws Exception
     */
    public String updateStatus(String query) throws Exception {
     ...
     * @throws Exception
     */
    public String deleteStatus(String query) throws Exception {
