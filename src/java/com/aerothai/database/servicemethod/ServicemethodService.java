 ...
 * @author chaia_000
 */
public class ServicemethodService {
	...
	try {
            ...
            if (isNotNull(opt)) query =  "SELECT * FROM service_method WHERE"+opt;
     ...
     * @throws Exception
     */
    public String updateServicemethod(String query) throws Exception {
     ...
     * @throws Exception
     */
    public String deleteServicemethod(String query) throws Exception {
