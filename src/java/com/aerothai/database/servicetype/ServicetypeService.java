...
public class ServicetypeService {
	...
	try {
            ...
            if (isNotNull(opt)) query =  "SELECT * FROM service_type WHERE"+opt;
     ...
     * @throws Exception
     */
    public String updateServicetype(String query) throws Exception {
     ...
     * @throws Exception
     */
    public String deleteServicetype(String query) throws Exception {
